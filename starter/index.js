...
const getMessagesForm = document.querySelector('#get-messages-form')
...
const getSecrets = (body) => {
  axios.post(`${baseURL}/get`, body).then(res => {
    console.log(res.data)
    displaySecrets(res.data)
...
function getHandler(e) {
  ...
  let pin = document.querySelector('#pin-input')
...
getMessagesForm.addEventListener('submit', getHandler)
